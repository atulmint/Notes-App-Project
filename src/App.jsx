...
const App = () => {
  ...
  key={idx}
  className="
    flex justify-between flex-col items-start relative
    h-52 w-40
...
>
  <div>
    <h3 className="leading-tight text-lg font-bold break-words line-clamp-2">
      {elem.title}
    </h3>

    <p className="mt-2 leading-tight text-xs font-semibold text-gray-600 break-words line-clamp-4">
      {elem.details}
    </p>
  </div>
